...
public class Lane_Activation {
	...
	{
		//Lane Activation Scenario # 1: Lane Activation-GSI  & GTO FRA Integration[Base lane]
        ...
        // WebDriver driver = new FirefoxDriver();
         ...
         driver.findElement(By.xpath("//a[@id='ctl00_MainContent_aNewproductcategory']")).click();
          ...
          //Selection of Lane Type as On-Going(Base)
          Thread.sleep(4000);
          driver.findElement(By.id("ctl00_MainContent_pnlShipperCallback_cmbLaneType_I")).click(); 
          driver.findElement(By.id("ctl00_MainContent_pnlShipperCallback_cmbLaneType_I")).sendKeys(Keys.ARROW_DOWN); 
          ...
          driver.findElement(By.id("ctl00_MainContent_pnlShipperCallback_cmbProductType_I")).sendKeys(Keys.ARROW_DOWN); 
          ...
          driver.findElement(By.id("ctl00_MainContent_pnlShipperCallback_cmbCategory_I")).sendKeys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ARROW_DOWN); 
